...
type AiPreferencesDataSourceTileProps = {
  title: string;
  subtitle: string;
  selected: boolean;
  onToggle: () => void;
...
export const AiPreferencesDataSourceTile = ({
  title,
  subtitle,
  selected,
  onToggle,
}: AiPreferencesDataSourceTileProps) => {
...
const TileButton = styled(motion.button)<{ $selected: boolean }>`
  position: relative;
  display: flex;
