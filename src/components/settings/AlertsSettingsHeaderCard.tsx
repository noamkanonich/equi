...
export const AlertsSettingsHeaderCard = () => {
  const t = useTranslations("settings.alerts.header");
  ...
  return (
    <StyledCard $padding="md">
      <Row>
        ...
        <Button $variant="secondary" onClick={handleTestNotifications}>
          <Send size={16} strokeWidth={1.9} aria-hidden />
          {t("testNotifications")}
        </Button>
      </Row>
      {testSent ? (
        <SettingsInfoBox variant="info" icon={Send}>
