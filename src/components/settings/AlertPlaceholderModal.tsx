...
type AlertPlaceholderModalProps = {
  isOpen: boolean;
  onClose: () => void;
  title: string;
};

export const AlertPlaceholderModal = ({
  isOpen,
  onClose,
  title,
}: AlertPlaceholderModalProps) => {
  const t = useTranslations("settings.alerts.modals");
  ...
  const content = (
    <Shell>
      ...
      <Body>
        <Description id={descriptionId}>{t("placeholderDescription")}</Description>
      </Body>
